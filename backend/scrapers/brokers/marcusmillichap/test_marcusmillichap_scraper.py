#!/usr/bin/env python
"""
Test script for MCP-based scraping of marcusmillichap's multifamily properties.
This script demonstrates property listing extraction from marcusmillichap's website.
"""
...
async def test_marcusmillichap_scraper() -> Dict[str, Any]:
    """
    Test the marcusmillichap scraper.
    ...
    scraper.storage = DataStorage("marcusmillichap")
    
    logger.info("Running marcusmillichap scraper test")
    ...
    if results.get("success"):
        ...
        logger.info(f"Successfully extracted {len(properties)} properties from marcusmillichap")
...
async def main():
    """Run the test."""
    logger.info("Starting marcusmillichap scraper test")
    results = await test_marcusmillichap_scraper()
    
    # Save results to a file
    with open("marcusmillichap_test_results.json", "w") as f:
