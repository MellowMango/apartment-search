#!/usr/bin/env python
"""
Test script for MCP-based scraping of transwestern's multifamily properties.
This script demonstrates property listing extraction from transwestern's website.
"""
...
async def test_transwestern_scraper() -> Dict[str, Any]:
    """
    Test the transwestern scraper.
    ...
    scraper.storage = DataStorage("transwestern")
    
    logger.info("Running transwestern scraper test")
    ...
    if results.get("success"):
        ...
        logger.info(f"Successfully extracted {len(properties)} properties from transwestern")
...
async def main():
    """Run the test."""
    logger.info("Starting transwestern scraper test")
    results = await test_transwestern_scraper()
    
    # Save results to a file
    with open("transwestern_test_results.json", "w") as f:
