#!/usr/bin/env python
"""
Test script for MCP-based scraping of acrmultifamily's multifamily properties.
This script demonstrates property listing extraction from acrmultifamily's website.
"""
...
async def test_acrmultifamily_scraper() -> Dict[str, Any]:
    """
    Test the acrmultifamily scraper.
    ...
    scraper.storage = DataStorage("acrmultifamily")
    
    logger.info("Running acrmultifamily scraper test")
    ...
    if results.get("success"):
        ...
        logger.info(f"Successfully extracted {len(properties)} properties from acrmultifamily")
...
async def main():
    """Run the test."""
    logger.info("Starting acrmultifamily scraper test")
    results = await test_acrmultifamily_scraper()
    
    # Save results to a file
    with open("acrmultifamily_test_results.json", "w") as f:
