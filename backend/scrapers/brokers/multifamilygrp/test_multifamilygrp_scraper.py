#!/usr/bin/env python
"""
Test script for MCP-based scraping of multifamilygrp's multifamily properties.
This script demonstrates property listing extraction from multifamilygrp's website.
"""
...
async def test_multifamilygrp_scraper() -> Dict[str, Any]:
    """
    Test the multifamilygrp scraper.
    ...
    scraper.storage = DataStorage("multifamilygrp")
    
    logger.info("Running multifamilygrp scraper test")
    ...
    if results.get("success"):
        ...
        logger.info(f"Successfully extracted {len(properties)} properties from multifamilygrp")
...
async def main():
    """Run the test."""
    logger.info("Starting multifamilygrp scraper test")
    results = await test_multifamilygrp_scraper()
    
    # Save results to a file
    with open("multifamilygrp_test_results.json", "w") as f:
