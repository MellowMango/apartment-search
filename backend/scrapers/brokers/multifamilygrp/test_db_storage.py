#!/usr/bin/env python
"""
Test script for database storage of multifamilygrp properties.
...
from backend.scrapers.brokers.multifamilygrp.test_multifamilygrp_scraper import test_multifamilygrp_scraper

async def test_database_storage():
    """
    Test storing multifamilygrp property data in both Supabase and Neo4j databases.
    """
    logger.info("Testing database storage for multifamilygrp properties")
    
    # First, extract property data using the existing test script
    logger.info("Extracting properties using the multifamilygrp scraper")
    extracted_data = await test_multifamilygrp_scraper()
