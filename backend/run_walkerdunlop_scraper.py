#!/usr/bin/env python3
"""
Runner script for the Walker & Dunlop scraper.
This script extracts property listings from walkerdunlop.com and saves them to the database.
"""
...
data_dir = Path("data")
html_dir = data_dir / "html" / "walkerdunlop"
screenshot_dir = data_dir / "screenshots" / "walkerdunlop"
extracted_dir = data_dir / "extracted" / "walkerdunlop"
...
async def run_walkerdunlop_scraper_with_db():
    """
    Run the Walker & Dunlop scraper with database storage.
    """
    logger.info("Starting Walker & Dunlop scraper runner")
    ...
    try:
        ...
        base_storage = ScraperDataStorage(broker_name="Walker & Dunlop")
        ...
        logger.info("Creating Walker & Dunlop scraper instance")
        scraper = WalkerDunlopScraper(storage=base_storage, mcp_base_url=mcp_base_url)
        ...
        if property_count > 0:
            ...
            for prop in properties:
                ...
                property_data["broker_name"] = "Walker & Dunlop"
                property_data["broker_url"] = "https://www.walkerdunlop.com"
        ...
        logger.info("Walker & Dunlop scraper run completed")
        return property_count
            
    except Exception as e:
        logger.exception(f"Error running Walker & Dunlop scraper: {str(e)}")
        return 0
...
if __name__ == "__main__":
    ...
    property_count = asyncio.run(run_walkerdunlop_scraper_with_db())
