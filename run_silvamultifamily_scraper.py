#!/usr/bin/env python3
"""
Run the Silva Multifamily scraper with database storage enabled.
"""
...
async def run_silvamultifamily_scraper_with_db():
    """Run the Silva Multifamily scraper with database storage."""
    start_time = time.time()
    
    logger.info("=== Silva Multifamily Scraper ===")
    logger.info("Starting Silva Multifamily scraper")
    ...
    scraper = SilvaMultifamilyScraper(storage=storage, mcp_base_url="http://localhost:3001")
    ...
    try:
        ...
        logger.info("=== Silva Multifamily Scraper Completed Successfully ===")
        return properties
    except Exception as e:
        logger.error(f"❌ Silva Multifamily scraper failed: {e}")
        return None
...
if __name__ == "__main__":
    ...
    # Run the scraper
    asyncio.run(run_silvamultifamily_scraper_with_db()) 