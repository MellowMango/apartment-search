#!/usr/bin/env python
"""
Main test script for Neo4j sync.
This script provides a clean way to test syncing data between Supabase and Neo4j
...
def create_test_data_in_supabase(supabase_client):
