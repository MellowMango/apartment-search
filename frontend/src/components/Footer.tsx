  ...
  return (
    <footer className="bg-primary text-primary-foreground py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">
              acquire<span className="opacity-80">.</span>
            </h3>
            <p className="text-primary-foreground/80">
              Providing comprehensive insights for multifamily properties in the Austin area.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/map" className="text-primary-foreground/80 hover:text-primary-foreground">
                  Map
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-primary-foreground/80">Email: info@acquire-apartments.com</p>
        ...
        <div className="mt-8 border-t border-primary-foreground/20 pt-6 text-center text-primary-foreground/70">
          <p>&copy; {currentYear} Acquire Apartments. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
